...
public class InventoryServiceGrpc {
  ...
  public static final String SERVICE_NAME = "com.example.dt.demo.grpc.inventory.service.InventoryServiceGrpc$InventoryServiceBlockingStub";

  // Static method descriptors that strictly reflect the proto.
  @io.grpc.ExperimentalApi("https://github.com/grpc/grpc-java/issues/1901")
  public static final io.grpc.MethodDescriptor<InventoryRequest,
          InventoryResponse> METHOD_DECREASE =
      io.grpc.MethodDescriptor.create(
          io.grpc.MethodDescriptor.MethodType.UNARY,
          generateFullMethodName(
              "com.example.dt.demo.grpc.inventory.service.InventoryServiceGrpc$InventoryServiceBlockingStub", "decrease"),
          io.grpc.protobuf.ProtoUtils.marshaller(InventoryRequest.getDefaultInstance()),
          io.grpc.protobuf.ProtoUtils.marshaller(InventoryResponse.getDefaultInstance()));
  ...
  public static abstract class InventoryServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void decrease(InventoryRequest request,
                         io.grpc.stub.StreamObserver<InventoryResponse> responseObserver) {
  ...
  public static final class InventoryServiceFutureStub extends io.grpc.stub.AbstractStub<InventoryServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<InventoryResponse> decrease(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_DECREASE:
          serviceImpl.decrease((InventoryRequest) request,
              (io.grpc.stub.StreamObserver<InventoryResponse>) responseObserver);
          break;
        default:
